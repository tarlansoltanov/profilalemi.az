(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/product/", ["jquery", "Site"], factory);
    ...
    global.products_index = mod.exports;
  }
  ...
  (function () {
    (0, _jquery.default)(document).ready(function () {
      ...
      $('#products thead tr:eq(1) th').each(function () {
        var title = $(this).text();
        if (title != '') {
      ...
      var options = _jquery.default.extend(true, {}, defaults, {
        ...
        initComplete: function () {
          ...
          $("#products_filter").append(column_search_btn);
          ...
          $("#products_filter").append(clear_search_btn);
          clear_search_btn.button();
          clear_search_btn.on('click', function () {
            $('#products_filter input').val('');
            table.search('').draw();
      ...
      $('#products').dataTable(options);

      setInterval(function () {
        $('#searchHeader th').each(function () {
          var cell_display = $('#products thead tr:eq(0) th:eq(' + $(this).index() + ')').css('display');
